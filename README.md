...
<h2>Portafolio y CV de Milton Barrientos</h2>
...
<p>
<a href="https://milton-barrientos.netlify.app"><b>milton-barrientos.netlify.app</b></a>
</p>
...
1. Dar de alta el sitio en [Google Search Console](https://search.google.com/search-console) y enviar `https://milton-barrientos.netlify.app/sitemap-index.xml`.
...
[MIT](LICENSE.txt) — plantilla original de [**midudev**](https://midu.dev), adaptada por [**crywhat**](https://milton-barrientos.netlify.app).
